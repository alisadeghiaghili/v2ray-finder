...
class TestConvenienceFunction:
    ...
    def test_fetch_urls_with_custom_headers(self):
        ...
        if results[0].success:
            ...
            assert 'X-Custom-Header' in results[0].content or True  # May not be in response body
...
class TestErrorHandling:
    ...
    async def test_unreachable_host(self):
        ...
        results = await fetcher.fetch_many_async(["https://definitely-not-a-real-domain-12345.com"])
